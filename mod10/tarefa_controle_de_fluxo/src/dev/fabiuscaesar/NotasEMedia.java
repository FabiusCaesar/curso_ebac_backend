...
public class NotasEMedia {
    ...
    private  double mediaDeRecuperação;
    ...
    public double getMediaDeRecuperação() {
        return mediaDeRecuperação;
    }

    public void setMediaDeRecuperação(double mediaDeRecuperação) {
        this.mediaDeRecuperação = mediaDeRecuperação;
    }
    ...
    public String verificarAprovacao(double media) {
        ...
        if (media >= mediaDeAprovacao) {
            return "Aprovado";
        } else if (media >= mediaDeRecuperação) {
             return "Recuperação";
        } else {
            return "Reprovado";
        }
