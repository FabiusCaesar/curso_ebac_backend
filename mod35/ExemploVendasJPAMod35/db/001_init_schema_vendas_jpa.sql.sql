...
ALTER SEQUENCE sq_produto RESTART WITH 1;
ALTER SEQUENCE sq_venda RESTART WITH 1;
ALTER SEQUENCE sq_produto_quantidade RESTART WITH 1;

-- Itens apagam ao apagar Produto
ALTER TABLE tb_produto_quantidade DROP CONSTRAINT fk_id_prod_venda;
ALTER TABLE tb_produto_quantidade
  ADD CONSTRAINT fk_id_prod_venda
  FOREIGN KEY (id_produto_fk) REFERENCES tb_produto(id) ON DELETE CASCADE;

-- Itens apagam ao apagar Venda
ALTER TABLE tb_produto_quantidade DROP CONSTRAINT fk_id_prod_venda_venda;
ALTER TABLE tb_produto_quantidade
  ADD CONSTRAINT fk_id_prod_venda_venda
  FOREIGN KEY (id_venda_fk) REFERENCES tb_venda(id) ON DELETE CASCADE;

-- Apagar Cliente apaga Vendas dele
ALTER TABLE tb_venda DROP CONSTRAINT fk_id_cliente_venda;
ALTER TABLE tb_venda
  ADD CONSTRAINT fk_id_cliente_venda
  FOREIGN KEY (id_cliente_fk) REFERENCES tb_cliente(id) ON DELETE CASCADE;